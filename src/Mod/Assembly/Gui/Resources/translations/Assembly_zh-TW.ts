...
<TS version="2.1" language="zh-TW" sourcelanguage="en">
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;將元件插入到活動裝配體中。這將建立指向零件、實體、圖元和裝配體的動態連結。要插入外部元件，請確保檔案&lt;b&gt;在當前會話中開啟&lt;/b&gt;&lt;/p&gt;&lt;ul&gt;&lt;li&gt;透過左鍵單擊列表中的專案進行插入。&lt;/li&gt;&lt;li&gt;透過右鍵單擊列表中的專案進行移除。&lt;/li&gt;&lt;li&gt;按住 Shift 鍵並單擊檢視即可新增元件的多個例項。&lt;/li&gt;&lt;/ul&gt;</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>解算當前活動的裝配體。</translation>
    </message>
  </context>
  <context>
    <name>QObject</name>
  ...
  <context>
    ...
    <message>
      ...
      <translation>零件子項：零件的子項將被新增到物料清單中</translation>
    </message>
    <message>
      ...
      <translation>僅零件：僅將零件容器和子裝配體新增到物料清單。零件設計主體、緊韌體或零件工作臺圖元等實體將被忽略。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>自定義列：“描述”和透過單擊“新增列”新增的其他自定義列的資料不會被覆蓋。如果列名以“.”開頭，後跟屬性名稱（例如“.Length”），則會自動填充該屬性值。雙擊或按 F2 鍵重新命名列（重新命名列目前會導致其資料丟失）。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>可以在電子表格工作臺偏好設定中自定義匯出的檔案格式</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>在插入新零件之前，必須先儲存裝配文件。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>大寫字母表示需要替換為實際值的變數。“initialValue”會動態替換為當前角度或距離。每個示例的更多詳細資訊請參見其工具提示。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation> - 平滑步驟：L1 + (L2 - L1)*(1/2) + (1/pi) * arctan(SLOPE*(time - T0)))</translation>
    </message>
    <message>
      ...
      <translation> - 平滑矩形脈衝： (H/pi)*(arctan(SLOPE*(time - T1)) - arctan(SLOPE*(time - T2)))</translation>
    </message>
    <message>
      ...
      <translation> - 平滑斜坡頂脈衝：((1/pi)*(arctan(1000*(time - T1)) - arctan(1000*(time - T2))))*(((H2 - H1)/(T2 - T1))*(time - T1) + H1)</translation>
    </message>
    <message>
...
ACC is the acceleration or coefficient of the second order. The function is a parabola.</source>
      <translation>C 為常數偏移量。
VEL 為直線的速度、斜率或梯度。
ACC 為二階加速度或係數。該函式為拋物線。</translation>
    </message>
    <message>
...
SLOPE defines the steepness of the transition between L1 and L2 about time = T0. Higher values gives sharper cornered steps. SLOPE = 1000 or greater are suitable.</source>
      <translation>L1 表示時間 = T0 之前的階躍水平。
L2 表示時間 = T0 之後的階躍水平。
SLOPE 定義 L1 和 L2 之間在時間 = T0 時的過渡陡度。值越高，階躍的轉角越尖銳。SLOPE = 1000 或更高為適宜。</translation>
    </message>
    <message>
...
SLOPE defines the steepness of the transition between 0 and H about time = T1 and T2. Higher values gives sharper cornered impulses. SLOPE = 1000 or greater are suitable.</source>
      <translation>H 是脈衝的高度。
T1 是脈衝的起始點。
T2 是脈衝的結束點。
SLOPE 定義了在時間 = T1 和 T2 時，0 到 H 之間的過渡的陡度。值越高，脈衝的拐角越尖銳。SLOPE = 1000 或更高是合適的。</translation>
    </message>
    <message>
...
SLOPE defines the steepness of the transition between 0 and H1 and H2 to 0 about time = T1 and T2 respectively. Higher values gives sharper cornered impulses. SLOPE = 1000 or greater are suitable.</source>
      <translation>這類似於方波脈衝，但其頂部為傾斜的斜坡。透過新增一系列此類脈衝，可用於構建平滑的分段線性函式。
T1 是脈衝的起始時間。
T2 是脈衝的結束時間。
H1 是斜坡起始點（T1 處）的高度。
H2 是斜坡結束點（T2 處）的高度。
SLOPE 定義了在 time = T1 和 T2 附近，從 0 到 H1、從 H2 到 0 之間過渡的陡峭程度。SLOPE 值越大，脈衝的邊角越尖銳。將 SLOPE 設為 1000 或更大比較合適。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>幀數不足，無法建立動畫。</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>正在裝配動畫…</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>未安裝 Pillow (PIL)。匯出 GIF 需要此元件。</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>這是 Reference1 物件內將用於接合的局部座標系統</translation>
    </message>
    <message>
      <location filename="../../../JointObject.py" line="230" />
      <source>This prevents Placement1 from recomputing, enabling custom positioning of the placement</source>
      <translation>這將阻止 Placement1 重新計算，從而允許對其位置進行自定義設定</translation>
    </message>
    <message>
      ...
      <translation>這是配合的第一個聯結器的附著偏移</translation>
    </message>
    <message>
      ...
      <translation>這是 參考2 物件內將被用於配合的區域性座標系</translation>
    </message>
    <message>
      <location filename="../../../JointObject.py" line="270" />
      <source>This prevents Placement2 from recomputing, enabling custom positioning of the placement</source>
      <translation>這可以防止 Placement2 重新計算，從而實現對放置（Placement）的自定義定位</translation>
    </message>
    <message>
      ...
      <translation>這是配合的第二個聯結器的附著偏移</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>設定接合點第一個標記（座標系）的附著偏移量</translation>
    </message>
    <message>
      ...
      <translation>設定連線件第二個標記點（座標系）的附著偏移量</translation>
    </message>
    <message>
      <location filename="../panels/TaskAssemblyCreateJoint.ui" line="231" />
      <source>Reverse the direction of the joint</source>
      <translation>反轉配合方向</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>只顯示列表中的零件</translation>
    </message>
    <message>
...
'Turn rigid'/'Turn flexible' command there, or by editing its Rigid property in the property editor.</source>
      <translation>設定插入的子裝配體是剛性的還是柔性的。
剛性：意味著新增的子裝配體在父裝配體中將被視為一個固體單元。
柔性：意味著新增的子裝配體將允許其各個元件的連線件在父裝配體中進行運動。
如何修改此行為
您可以隨時更改此行為，方法有兩種：
在文件樹中：右鍵單擊文件樹中的子裝配體，然後切換**“設為剛性”/“設為柔性”**命令。
在屬性編輯器中：編輯其Rigid（剛性）屬性。
</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>允許按 Esc 鍵退出編輯模式</translation>
    </message>
    <message>
...
The files are named "runPreDrag.asmt" and "dragging.log" and are located in the default directory of std::ofstream (on Windows it's the desktop)</source>
      <translation>記錄求解器的拖動步驟。這對於報告 bug 非常有用。
檔名為 "runPreDrag.asmt" 和 "dragging.log"，位於 std::ofstream 的預設目錄中（在 Windows 系統上為桌面）</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>當你向裝配體中插入第一個零件時，它將被自動固定</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;建立一個螺旋連線，用於將帶有滑動連線的零件與帶有旋轉連線的零件連線起來&lt;/p&gt;&lt;p&gt;請選擇與旋轉連線和滑動連線相同的座標系。螺距半徑定義了旋轉螺桿與滑動零件之間的運動比率。&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>齒輪/皮帶配合</translation>
    </message>
    <message>
      ...
      <translation>&lt;p&gt;建立將兩個旋轉齒輪連線在一起的齒輪或皮帶接合點&lt;/p&gt;&lt;p&gt;選擇與旋轉接合點相同的座標系。&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>如果勾選，零件將作為單個實體被選取</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>僅將零件容器和子裝配體新增到物料清單。不包括實體（例如實體、緊韌體、圖元）。</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;建立當前裝配體的物料清單。如果裝配體處於活動狀態，它將作為該裝配體的物料清單 (BOM)。否則，它將作為整個文件的物料清單。&lt;/p&gt;&lt;p&gt;BOM 物件是一個文件物件，用於儲存物料清單的設定。它也是一個電子表格物件，因此您可以輕鬆檢視物料清單。如果您不需要將 BOM 物件儲存為文件物件，只需匯出並取消任務即可。&lt;/p&gt;&lt;p&gt;“索引”、“名稱”、“檔名”和“數量”列會在重新計算時自動生成。“說明”和自定義列不會被覆蓋。&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>將一個新零件插入到當前啟用的裝配體中。新零件的原點可以在裝配體中定位。</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>在當前文件或當前的活躍的裝配體（如果有）中建立裝配物件。每個檔案限定一個根裝配體。</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;1 - 如果裝配體處於活動狀態：建立一個接合點，將兩個零件永久鎖定在一起，防止任何移動或旋轉&lt;/p&gt;&lt;p&gt;2 - 如果零件處於活動狀態：透過匹配選定的座標系來定位子零件。選定的第二個零件將會移動。&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>建立旋轉配合，允許所選零件之間圍繞單軸旋轉</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>建立圓柱配合，允許裝配體零件之間沿單軸旋轉和平移</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>建立滑塊配合，允許所選零件之間沿單軸線移動，但它們之間的旋轉</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>建立球窩配合，把零件連線在一個點，允許圍繞重合的連線點不受限制地轉動</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;建立一個距離接合點，用於固定所選物件之間的距離&lt;/p&gt;&lt;p&gt;根據選擇建立多個不同接合點中的一個。例如，當平面和圓柱體之間的距離為 0 時，將建立一個切線接合點。當平面之間的距離為 0 時，將使它們共面。&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>建立平行配合，使選定座標系的 Z 軸平行</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>建立垂直配合，使選定座標系的 Z 軸之間互相垂直</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>建立角度配合，固定選定座標系的 Z 軸之間的角度</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>齒輪齒條配合</translation>
    </message>
    <message>
      ...
      <translation>&lt;p&gt;建立一個齒輪齒條連線，用於將帶有滑動連線的零件與帶有旋轉連線的零件連線起來&lt;/p&gt;&lt;p&gt;請選擇與旋轉連線和滑動連線相同的座標系。節圓半徑定義了齒條與齒輪之間的運動比率。&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;建立一個齒輪接合點，將兩個旋轉的齒輪連線在一起。它們的旋轉方向相反。&lt;/p&gt;&lt;p&gt;選擇與旋轉接合點相同的座標系。&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;建立一個皮帶接合點，將兩個旋轉物件連線在一起。它們的旋轉方向相同。&lt;/p&gt;&lt;p&gt;選擇與旋轉接合點相同的座標系。&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;切換零件的固定狀態。&lt;/p&gt;&lt;p&gt;固定零件會將其在元件中的位置永久鎖定，防止任何移動或旋轉。&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>建立當前裝配體的新算例</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>建立當前裝配體的爆炸檢視</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>完全載入文件</translation>
    </message>
  </context>
  <context>
...
Note: Currently this selects only unconnected parts, not constrained parts that still have free DoF.</source>
      <translation>元件中存在未受約束的零件，從而導致了這些自由度。
點選以選擇這些未受約束的零件。
注意：當前僅選擇未連線的零件，不包括已受約束但仍具有自由度的零件。</translation>
    </message>
    <message>
      <location filename="../../TaskAssemblyMessages.cpp" line="70" />
      <source>Click to select these malformed joints.</source>
      <translation>單擊以選中那些異常的配合。</translation>
    </message>
  </context>
  <context>
